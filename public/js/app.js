...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('example-component', __webpack_require__(18));
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('szablon', __webpack_require__(21));
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('zlecenia', __webpack_require__(24));
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('login', __webpack_require__(45));
...
Component.options.__file = "resources\\assets\\js\\components\\Szablon.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6cf63edc", Component.options)
  } else {
    hotAPI.reload("data-v-6cf63edc", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _vm._v(" "),
      _c("v-content", [_c("v-container", [_c("zlecenia")], 1)], 1),
      _vm._v(" "),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-6cf63edc", module.exports)
  }
}
...
Component.options.__file = "resources\\assets\\js\\components\\zlecenia.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-e63cf6b0", Component.options)
  } else {
    hotAPI.reload("data-v-e63cf6b0", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
      ...
      headers: [{
        ...
        value: 'nazwa'
      }, { text: 'Opis', value: 'opis' }, { text: 'Fat (g)' }, { text: 'Akcja' }],
      items: []
    };
  },
  ...
  created: function created() {
    ...
    __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('http://localhost:8000/api/zlecenia/').then(function (response) {
            ...
            scopedSlots: _vm._u([
              {
                ...
                fn: function(props) {
                  return [
                    _c("td", [_vm._v(_vm._s(props.item.nazwa))]),
                    _vm._v(" "),
                    _c("td", { staticClass: "text-xs-right" }, [
                      _vm._v(_vm._s(props.item.opis))
                    ]),
                    _vm._v(" "),
                    _c("td", [_vm._v("dsadas")]),
                    _vm._v(" "),
                    _c("td", [_vm._v("edytuj | usuń")])
                  ]
                }
              }
            ])
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-e63cf6b0", module.exports)
  }
}
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    zaloguj: function zaloguj() {
      var _this = this;

      //alert(this.logowanie.login+this.logowanie.password),
      __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post('/login', { email: this.logowanie.email, password: this.logowanie.password }).then(function (response) {
      ...
      this.logowanie.email = '', this.logowanie.password = '';
    }
  }
                                  ...
                                  _c(
                                    "v-btn",
                                    {
                                      attrs: {
                                        ...
                                        large: "",
                                        href:
                                          "https://codepen.io/johnjleider/pen/wyYVVj",
                                        target: "_blank"
                                      },
                                      slot: "activator"
                                    },
                              ...
                              _c(
                                ...
                                [
                                  _c("v-text-field", {
                                    ...
                                    model: {
                                      value: _vm.logowanie.email,
                                      callback: function($$v) {
                                        _vm.$set(_vm.logowanie, "email", $$v)
                                      },
                                      expression: "logowanie.email"
                                    }
                                  }),
                                  _vm._v(" "),
                                  _c("v-text-field", {
                                    ...
                                    model: {
                                      value: _vm.logowanie.password,
                                      callback: function($$v) {
                                        _vm.$set(_vm.logowanie, "password", $$v)
                                      },
                                      expression: "logowanie.password"
                                    }
                                  })
                                ],
                                1
